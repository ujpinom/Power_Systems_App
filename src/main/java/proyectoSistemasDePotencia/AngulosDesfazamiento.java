...
public class AngulosDesfazamiento {
  ...
  public static void establecerAngulosDeDesfazamiento(
      ArrayList<Barras> barras,
      Barras barraFallada,
      String[] conexionesBarras,
        ...
        if (!barras.get(u).isEstablecido()) {
          ...
          if (u != 0 && v != 0) {
            ...
            if (barras.get(u).getTipoConexionBarra().equals(barras.get(v).getTipoConexionBarra())) {
              ...
              if (barras.get(u).getTipoConexionBarra().equals("Y")
                  && barras.get(v).getTipoConexionBarra().equals("D")) {

                barras
                    .get(u)
                    .setAnguloVoltajeSecuencia1(barras.get(v).getAnguloVoltajeSecuencia1() + 30);
                barras
                    .get(u)
                    .setAnguloVoltajeSecuencia2(barras.get(v).getAnguloVoltajeSecuencia2() - 30);
                barras.get(u).setEstablecido(true);

              } else if (barras.get(u).getTipoConexionBarra().equals("D")
                  && barras.get(v).getTipoConexionBarra().equals("Y")) {
            ...
            if ((barras.get(u).getTipoConexionBarra().equals("O")
                    && barras.get(v).getTipoConexionBarra().equals("Y"))
                || (barras.get(u).getTipoConexionBarra().equals("O")
                    && barras.get(v).getTipoConexionBarra().equals("D"))
                || ((barras.get(u).getTipoConexionBarra().equals("Y")
                        && barras.get(v).getTipoConexionBarra().equals("O"))
                    || (barras.get(u).getTipoConexionBarra().equals("D")
                        && barras.get(v).getTipoConexionBarra().equals("O")))) {
            ...
            if (barras.get(v).getTipoConexionBarra().equals(barras.get(u).getTipoConexionBarra())) {
              ...
              if (barras.get(v).getTipoConexionBarra().equals("Y")
                  && barras.get(u).getTipoConexionBarra().equals("D")) {

                barras
                    .get(v)
                    .setAnguloVoltajeSecuencia1(barras.get(u).getAnguloVoltajeSecuencia1() + 30);
                barras
                    .get(v)
                    .setAnguloVoltajeSecuencia2(barras.get(u).getAnguloVoltajeSecuencia2() - 30);
                barras.get(v).setEstablecido(true);

              } else if (barras.get(v).getTipoConexionBarra().equals("D")
                  && barras.get(u).getTipoConexionBarra().equals("Y")) {
            ...
            if ((barras.get(v).getTipoConexionBarra().equals("O")
                    && barras.get(u).getTipoConexionBarra().equals("Y"))
                || (barras.get(v).getTipoConexionBarra().equals("O")
                    && barras.get(u).getTipoConexionBarra().equals("D"))
                || ((barras.get(v).getTipoConexionBarra().equals("Y")
