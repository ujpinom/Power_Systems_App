...
public class DeterminacionPotenciasBarras {
  ...
  public static void potenciasEnBarrasComPV(
      List<Barras> barras, List<Complejo>[] solucion, Complejo[][] matAdj) {
  ...
  private static double potenciaReal(
      int indexBarra, Barras b, List<Complejo>[] solucion, Complejo[][] matAdj) {
    ...
    Complejo tensionBarraConjugada =
        Complejo.conjugado(solucion[indexBarra].get(solucion[indexBarra].size() - 1));
  ...
  private static double potenciaImaginaria(
      int indexBarra, Barras b, List<Complejo>[] solucion, Complejo[][] matAdj) {
  ...
  public static void calculoPerdidasPotenciaLineas(
      List<Barras> barras,
      List<Complejo>[] solucion,
      List<Lineas> lineas,
      List<Transformador> trafos,
      Complejo[][] yBus,
      Complejo[][] perdidasLineas,
    ...
    for (Lineas linea : lineas) {
      ...
      Complejo SB1B2 =
          Complejo.producto(
              new Complejo(SPController.BASE_SISTEMA, 0.0), Complejo.producto(tensionB1, I));
      ...
      SB1B2 =
          Complejo.producto(
              new Complejo(SPController.BASE_SISTEMA, 0.0), Complejo.producto(tensionB2, I));
