...
public class ConexionesBarras {
  ...
  public static String[] establecerConexionesBarras(
      ArrayList<Transformador> trafo, ArrayList<Barras> barras) {
        ...
        String xx =
            Character.toString(
                trafo
                    .get(i)
                    .getConexionPrimaria()
                    .charAt(trafo.get(i).getConexionPrimaria().length() - 1));
        ...
        String xx =
            Character.toString(
                trafo
                    ...
                    .charAt(trafo.get(i).getConexionSecundaria().length() - 1));
        conexionesBarras[Integer.parseInt(xx) - 1] = "Y";
      }
