...
public class FallaLineaALinea {
  ...
  public void corrientePuntoFalla() {
    ...
    double impedanciaTotal =
        matrizSecuencia1[barras.indexOf(barraFallada) - 1][barras.indexOf(barraFallada) - 1]
            + matrizSecuencia2[barras.indexOf(barraFallada) - 1][barras.indexOf(barraFallada) - 1]
    ...
    try {
      ...
      corrientePuntoFalla =
          Complejo.cociente(
              new Complejo(barraFallada.getVoltajePrefalla(), 0), new Complejo(0, impedanciaTotal));
      ...
      Complejo iB =
          Complejo.suma(
              Complejo.producto(aCuadrado, corrientePuntoFalla),
      ...
      if (i == (barras.indexOf(barraFallada) - 1)) {
        ...
        double vA1 =
            barraFallada.getVoltajePrefalla()
                - matrizSecuencia1[barras.indexOf(barraFallada) - 1][
                        barras.indexOf(barraFallada) - 1]
                    * corrientePuntoFalla.modulo();
        double vA2 = vA1;
        ...
        Complejo iB =
            Complejo.suma(
                Complejo.producto(aCuadrado, new Complejo(vA1, 0)),
                Complejo.producto(a, new Complejo(vA2, 0)));
        ...
        double vA1 =
            barras.get(i + 1).getVoltajePrefalla()
                - matrizSecuencia1[barras.indexOf(barraFallada) - 1][i]
                    * corrientePuntoFalla.modulo();
        double vA2 =
            matrizSecuencia2[barras.indexOf(barraFallada) - 1][i] * corrientePuntoFalla.modulo();

        vectorVoltajesSecuencia1.add(vA1);
        vectorVoltajesSecuencia2.add(vA2);

        Complejo vASecuencia1 =
            Complejo.polar2Cartesiano(vA1, barras.get(i + 1).getAnguloVoltajeSecuencia1());
        Complejo vASecuencia2 =
            Complejo.polar2Cartesiano(vA2, barras.get(i + 1).getAnguloVoltajeSecuencia2());
