...
public class MatricesController {
  ...
  @FXML private Button acceptar;

  @FXML private TextField epsilon;

  @FXML private TextField aceleracion;

  @FXML private TextField iteraciones;

  @FXML private TextField holaperro;
  ...
  private void aceptarButton() {
    ...
    if (ep || ite || tace) {
      ...
      JOptionPane.showMessageDialog(
          null,
          "Ingrese datos de tipo n̼merico positivos utilizando punto como separador decimal");
