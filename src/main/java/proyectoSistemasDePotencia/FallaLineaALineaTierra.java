...
public class FallaLineaALineaTierra {
	...
	public FallaLineaALineaTierra(double[][] matrizImpedanciaZ0, double[][] matrizImpedanciaZ1,
			double[][] matrizImpedanciaZ2, List<Barras> barras, List<Lineas> lineas,
			List<Transformador> trafo, Barras barraFallada, List<Generadores> generador) {
	...
	public void corrientesPuntoFalla() {
		...
		try {
			...
			corrientePuntoFallaSecuencia1 = Complejo.cociente(new Complejo(barraFallada.getVoltajePrefalla(), 0),
			...
			impedanciTotal = matrizImpedanciaZ2[indexBarraFallada - 1][indexBarraFallada - 1]
					/ (matrizImpedanciaZ2[indexBarraFallada - 1][indexBarraFallada - 1] +
							matrizImpedanciaZ0[indexBarraFallada - 1][indexBarraFallada - 1]
							+ 3 * barraFallada.getImpedanciaFalla());
	...
	public void vectorVoltajes() {
		...
		for (int i = 0; i < matrizImpedanciaZ0.length; i++) {
			...
			if (i == (indexBarraFallada - 1)) {
				...
				vA1 = barraFallada.getVoltajePrefalla() - (corrientePuntoFallaSecuencia1.modulo()
				...
				vA1 = barras.get(i + 1).getVoltajePrefalla()
						- (corrientePuntoFallaSecuencia1.modulo() * matrizImpedanciaZ1[i][indexBarraFallada - 1]);
