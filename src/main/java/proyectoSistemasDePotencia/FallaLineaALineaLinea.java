...
public class FallaLineaALineaLinea {
  ...
  public FallaLineaALineaLinea(
    ...
    this.matrizSecuencia1 = zBarrafinal1;
    this.matrizSecuencia2 = zBarrafinal2;
  ...
  public void calculoCorrientePuntoFalla() {
    ...
    double impedanciaTotal =
        matrizSecuencia1[matrizSecuencia1.length - 1][matrizSecuencia1.length - 1]
            + matrizSecuencia2[matrizSecuencia2.length - 1][matrizSecuencia2.length - 1]
            + 3 * elementoFallado.getImpedanciaFalla();

    try {

      corrientePuntoFalla1 =
          Complejo.cociente(
      ...
      Complejo iB =
          Complejo.suma(
              Complejo.producto(aCuadrado, corrientePuntoFalla1),
              Complejo.producto(a, corrientePuntoFalla2));
  ...
  public void vectoresVoltaje() {
    ...
    vA1Imaginario =
        Complejo.resta(
            ...
            Complejo.producto(
                new Complejo(
                    0, matrizSecuencia1[matrizSecuencia1.length - 1][matrizSecuencia1.length - 1]),
                corrientePuntoFalla1));
    ...
    vA2Imaginario =
        Complejo.producto(
            ...
            Complejo.producto(
                new Complejo(
                    0, matrizSecuencia2[matrizSecuencia1.length - 1][matrizSecuencia1.length - 1]),
                corrientePuntoFalla2));
    ...
    for (int i = 1; i < barras.size(); i++) {
      ...
      double vA1 =
          barras.get(i).getVoltajePrefalla()
              - matrizSecuencia1[matrizSecuencia1.length - 1][i - 1]
                  * corrientePuntoFalla1.modulo();

      double vA2 =
          matrizSecuencia2[matrizSecuencia1.length - 1][i - 1] * corrientePuntoFalla2.modulo();

      vectorVoltajesSecuencia1.add(vA1);
      vectorVoltajesSecuencia2.add(vA2);

      Complejo vASecuencia1 =
          Complejo.polar2Cartesiano(vA1, barras.get(i).getAnguloVoltajeSecuencia1());
      Complejo vASecuencia2 =
          Complejo.polar2Cartesiano(vA2, barras.get(i).getAnguloVoltajeSecuencia2());
      ...
      Complejo vFaseB =
          Complejo.suma(
              Complejo.producto(aCuadrado, vASecuencia1), Complejo.producto(a, vASecuencia2));
      ...
      Complejo vFaseC =
          Complejo.suma(
              Complejo.producto(a, vASecuencia1), Complejo.producto(aCuadrado, vASecuencia2));
  ...
  public void setAngulosBarras() {
    ...
    // AngulosDesfazamiento.establecerAngulosDeDesfazamiento(barras, barraFallada,
    // conexionesBarras, adyacencias);

  }

  public void setConexionesBarras() {

    // this.conexionesBarras=ConexionesBarras.establecerConexionesBarras(trafo,
    // barras);
