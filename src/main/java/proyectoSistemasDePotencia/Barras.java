...
public class Barras {
	...
	private boolean barraFromPV2PQ = false; // Indica si la barra fue cambiada de barra PV a PQ debido a violaciones de
	...
	private double flowPowerRealCalculada; // Potencia calculada para las barras de compensaciÃ³n y PV luego de obtener
											// la soluciÃ³n del problemas de flujos de potencia.
	private double flowPowerImagCalculada;//// Potencia calculada para las barras de compensaciÃ³n y PV luego de obtener
											//// la soluciÃ³n del problemas de flujos de potencia.
	...
	public void setNombreBarra(String nombreBarra) {
		String old = this.nombreBarra;
		this.nombreBarra = nombreBarra;
		this.pcs.firePropertyChange("nombreBarra", old, nombreBarra);
	}
