...
public class InfoTrafo extends GridPane {
  ...
  private Text csecundaria =
      new Text("ConexiÃ³n lado secundario (-BX indica la barra de conexiÃ³n)");
  ...
  public InfoTrafo(Transformador trafo) {
    ...
    cbo.setOnAction(
        e -> {
          ...
          if (cbo.getValue().equals("YN-" + trafo.getBarra1().getNombreBarra())
              || cbo.getValue().equals("YN-" + trafo.getBarra2().getNombreBarra())) {
        ...
        e -> {
          if (items.indexOf(cbo1.getValue()) == indexConexionprimaria) {
            JOptionPane.showMessageDialog(
                null, "No puede seleccionar la misma barra dos veces. Escoja la otra barra");

          } else {
            setConexionSecundaria(items.indexOf(cbo1.getValue()));
            if (cbo1.getValue().equals("YN-" + trafo.getBarra1().getNombreBarra())
                || cbo1.getValue().equals("YN-" + trafo.getBarra2().getNombreBarra())) {
    ...
    btncerrar.setOnAction(
        e -> {
          ...
          if (z1t.getText().contains(",")
              || z2t.getText().contains(",")
              || z0t.getText().contains(",")
              || vz1t
              || vz2t
              || vz0t
              || rtrafo) {
            ...
            JOptionPane.showMessageDialog(
                null, "Ingrese datos de tipo nÃºmerico utilizando punto como separador decimal");
          } else {
