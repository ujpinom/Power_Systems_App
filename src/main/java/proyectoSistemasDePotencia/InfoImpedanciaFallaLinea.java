...
public class InfoImpedanciaFallaLinea extends GridPane {
  ...
  private Label descripcionvoltajePuntoFalla =
      new Label("Ingrese la tensiÃ³n en el punto de falla de la lÃ­nea");
  ...
  public InfoImpedanciaFallaLinea(String nombreElemento, Lineas lineaFallada) {
    ...
    infolinea.setText(
        "IMPEDANCIA DE FALLA OCURRIDA SOBRE EL ELEMENTO "
            + nombreElemento
