...
public class FallaLineaALineaTierraEnLinea {
  ...
  public FallaLineaALineaTierraEnLinea(
      double[][] matrizSecuencia0,
      double[][] matrizSecuencia1,
      double[][] matrizSecuencia2,
      List<Barras> barras,
      List<Lineas> lineas,
      List<Transformador> trafo,
      List<Generadores> generador,
      Lineas elementoFallado) {
    ...
    double[][] zBarrafinal1 =
        zb1.inserccionEntreBarras(
            matrizInserccionEntreDosBarras1,
            barras.indexOf(elementoFallado.getBarra1()),
            barras.indexOf(elementoFallado.getBarra2()));

    double[][] zBarrafinal2 =
        zb2.inserccionEntreBarras2(
            matrizInserccionEntreDosBarras2,
            barras.indexOf(elementoFallado.getBarra1()),
            barras.indexOf(elementoFallado.getBarra2()));

    double[][] zBarrafinal0 =
        zb0.inserccionEntreBarras0(
            matrizInserccionEntreDosBarras0,
            barras.indexOf(elementoFallado.getBarra1()),
            barras.indexOf(elementoFallado.getBarra2()));

    this.matrizImpedanciaZ0 = zBarrafinal0;
    this.matrizImpedanciaZ1 = zBarrafinal1;
    this.matrizImpedanciaZ2 = zBarrafinal2;
  ...
  public void contribucionBarras() {
    ...
    for (int i = 0; i < barras.size(); i++) {
      ...
      if (elementoFallado.getBarra1() == barras.get(i)
          || elementoFallado.getBarra2() == barras.get(i)) {

        try {

          Complejo iA0 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia0.get(i - 1) - vA0Imaginario.modulo(), 0),
                  new Complejo(0, elementoFallado.getimpedanciaLineaZ0() / 2));

          Complejo iA2 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia2.get(i - 1) - vA2Imaginario.modulo(), 0),
                  new Complejo(0, elementoFallado.getimpedanciaLineaZ2() / 2));

          Complejo iA1 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia1.get(i - 1) - vA1Imaginario.modulo(), 0),
    ...
    for (int i = 0; i < generador.size(); i++) {
      ...
      try {
        ...
        Complejo iA1 =
            Complejo.cociente(
                Complejo.resta(
                    new Complejo(generador.get(i).getBarra().getVoltajePrefalla(), 0),
                    Complejo.polar2Cartesiano(
                        vectorVoltajesSecuencia1.get(indexBarraGe - 1),
        ...
        Complejo iA2 =
            Complejo.cociente(
                Complejo.producto(
                    new Complejo(-1, 0),
                    Complejo.polar2Cartesiano(
                        vectorVoltajesSecuencia2.get(indexBarraGe - 1),
        ...
        Complejo iB =
            Complejo.suma(
                Complejo.suma(Complejo.producto(aCuadrado, iA1), Complejo.producto(a, iA2)), iA0);
        ...
        Complejo iC =
            Complejo.suma(
                Complejo.suma(Complejo.producto(a, iA1), Complejo.producto(aCuadrado, iA2)), iA0);
  ...
  public void vectorVoltajes() {
    ...
    vA1Imaginario =
        Complejo.resta(
            new Complejo(elementoFallado.getTensionLineaPuntoFalla(), 0),
            Complejo.producto(
                new Complejo(
                    0,
                    matrizImpedanciaZ1[matrizImpedanciaZ2.length - 1][
                        matrizImpedanciaZ2.length - 1]),
                corrientePuntoFallaSecuencia1));
    ...
    for (int i = 1; i < barras.size(); i++) {
      ...
      vA1 =
          barras.get(i).getVoltajePrefalla()
              - (corrientePuntoFallaSecuencia1.modulo()
                  * matrizImpedanciaZ1[i - 1][matrizImpedanciaZ2.length - 1]);
      vA2 =
          corrientePuntoFallaSecuencia2.modulo()
              * matrizImpedanciaZ2[i - 1][matrizImpedanciaZ2.length - 1];
      vA0 =
          corrientePuntoFallaSecuencia0.modulo()
              * matrizImpedanciaZ0[i - 1][matrizImpedanciaZ2.length - 1];
      ...
      vA =
          Complejo.suma(
              Complejo.suma(new Complejo(vA1, 0), new Complejo(vA2, 0)), new Complejo(vA0, 0));
      ...
      vB =
          Complejo.suma(
              Complejo.suma(
                  Complejo.producto(new Complejo(vA1, 0), aCuadrado),
                  Complejo.producto(new Complejo(vA2, 0), a)),
              new Complejo(vA0, 0));
      ...
      vC =
          Complejo.suma(
              Complejo.suma(
                  Complejo.producto(new Complejo(vA2, 0), aCuadrado),
                  Complejo.producto(new Complejo(vA1, 0), a)),
              new Complejo(vA0, 0));
  ...
  public void corrientePuntoFalla() {
    ...
    try {
      ...
      double impedanciTotal =
          matrizImpedanciaZ1[matrizImpedanciaZ1.length - 1][matrizImpedanciaZ1.length - 1]
              + ((matrizImpedanciaZ2[matrizImpedanciaZ1.length - 1][matrizImpedanciaZ1.length - 1]
                      * (matrizImpedanciaZ0[matrizImpedanciaZ1.length - 1][
                              matrizImpedanciaZ1.length - 1]
                          + 3 * elementoFallado.getImpedanciaFalla()))
                  / (matrizImpedanciaZ2[matrizImpedanciaZ1.length - 1][
                          matrizImpedanciaZ1.length - 1]
                      + matrizImpedanciaZ0[matrizImpedanciaZ1.length - 1][
                          matrizImpedanciaZ1.length - 1]
                      + 3 * elementoFallado.getImpedanciaFalla()));
      ...
      corrientePuntoFallaSecuencia2 =
          Complejo.producto(
              Complejo.producto(new Complejo(-1, 0), corrientePuntoFallaSecuencia1),
      ...
      Complejo iA =
          Complejo.suma(
              Complejo.suma(corrientePuntoFallaSecuencia1, corrientePuntoFallaSecuencia2),
              corrientePuntoFallaSecuencia0);
      ...
      Complejo iB =
          Complejo.suma(
              Complejo.suma(
                  Complejo.producto(aCuadrado, corrientePuntoFallaSecuencia1),
                  Complejo.producto(a, corrientePuntoFallaSecuencia2)),
              corrientePuntoFallaSecuencia0);
      ...
      Complejo iC =
          Complejo.suma(
              Complejo.suma(
                  Complejo.producto(aCuadrado, corrientePuntoFallaSecuencia2),
                  Complejo.producto(a, corrientePuntoFallaSecuencia1)),
              corrientePuntoFallaSecuencia0);
