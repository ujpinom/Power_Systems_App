...
public class FallaAsimetricaLineas {
  ...
  public FallaAsimetricaLineas(
    ...
    this.matrizSecuencia0 = zBarrafinal0;
    ...
    for (int i = 0; i < barras.size(); i++) {
      ...
      if (elementoFallado.getBarra1() == barras.get(i)
        ...
        try {
          ...
          Complejo iA0 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia0.get(i - 1) - vA0Imaginario, 0),
                  new Complejo(0, elementoFallado.getimpedanciaLineaZ0() / 2));

          Complejo iA2 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia2.get(i - 1) - vA2Imaginario, 0),
                  new Complejo(0, elementoFallado.getimpedanciaLineaZ2() / 2));

          Complejo iA1 =
              Complejo.cociente(
                  new Complejo(vectorVoltajesSecuencia1.get(i - 1) - vA1Imaginario, 0),
  ...
  public void calculoCorrienteFalla() {
    ...
    double corrienteFalla =
        elementoFallado.getTensionLineaPuntoFalla()
  ...
  public void calculoVectorVoltajes() {
    ...
    vA0Imaginario =
        matrizSecuencia0[matrizSecuencia0.length - 1][matrizSecuencia0.length - 1] * corrienteFalla;
    vA1Imaginario =
        elementoFallado.getTensionLineaPuntoFalla()
            + matrizSecuencia1[matrizSecuencia0.length - 1][matrizSecuencia0.length - 1]
                * corrienteFalla;
    vA2Imaginario =
        matrizSecuencia2[matrizSecuencia0.length - 1][matrizSecuencia0.length - 1] * corrienteFalla;
    ...
    for (int i = 0; i < matrizSecuencia1.length - 1; i++) {
      ...
      double vA1 =
          barras.get(i + 1).getVoltajePrefalla()
              + matrizSecuencia1[i][matrizSecuencia1.length - 1] * corrienteFalla;
