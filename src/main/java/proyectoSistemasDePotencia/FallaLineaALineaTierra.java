  ...
  public void corrientesPuntoFalla() {
    ...
    try {
      ...
      double impedanciTotal =
          matrizImpedanciaZ1[indexBarraFallada - 1][indexBarraFallada - 1]
              + ((matrizImpedanciaZ2[indexBarraFallada - 1][indexBarraFallada - 1]
                      * (matrizImpedanciaZ0[indexBarraFallada - 1][indexBarraFallada - 1]
      ...
      corrientePuntoFallaSecuencia1 =
          Complejo.cociente(
              new Complejo(barraFallada.getVoltajePrefalla(), 0), new Complejo(0, impedanciTotal));
      ...
      if (i == (indexBarraFallada - 1)) {
        ...
        vA1 =
            barras.get(i + 1).getVoltajePrefalla()
                - (corrientePuntoFallaSecuencia1.modulo()
                    * matrizImpedanciaZ1[i][indexBarraFallada - 1]);
